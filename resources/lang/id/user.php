...
return [
    ...
    "message_change_password_failed" => "Merubah Password Anda Gagal",
    "message_change_password_failed_new" => "Password Baru Anda Sama Dengan Sebelumnya",
    "title_change_password_success" => "Merubah Password Sukses!",
];