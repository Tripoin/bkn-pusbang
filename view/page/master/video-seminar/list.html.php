...
$Datatable->header(array(lang("general.no"), lang("master.title"), lang("master.url"), lang("general.action")));
$no = $list_data['from'];
...
foreach ($list_data['item'] as $value) {
    ...
    $Datatable->body(array($no, $value[$data->getTitle()], $value[$data->getUrlVideo()],$action_edit.$action_delete));
    $no += 1;
}
