...
?>
<?php echo $Form->id('quota')->attr('style="width:20%;"')->value($get_data[$data->getQuota()])->title(lang('transaction.number_of_participants'))->placeholder(lang('transaction.number_of_participants') . ' ....')->textbox(); ?>
