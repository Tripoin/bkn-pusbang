...
echo $Datatable->show();
$action_kirim = Button()->onClick('ajaxPostModalManual(\'' . URL($this->admin_theme_url .$this->indexUrl . '/assignment/'.$activity.'/edit') . '\',\'id=' . $value[$data->getId()] . '\')')->icon('fa fa-paper-plane')->label('Kirim Surat Penugasan Panitia')->title('Kirim Surat Penugasan Panitia')->buttonManual();
?>
<?=$action_kirim;?>
<script>
    $(function () {
