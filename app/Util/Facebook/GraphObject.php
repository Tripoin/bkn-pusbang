...
class GraphObject
{
   ...
   * @return mixed
   */
  public function getProperty($name, $type = 'app\Util\Facebook\GraphObject')
  {
   ...
   * @return array
   */
  public function getPropertyAsArray($name, $type = 'app\Util\Facebook\GraphObject')
  {
    $target = array();
