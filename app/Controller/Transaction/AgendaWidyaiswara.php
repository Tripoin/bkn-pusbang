...
class AgendaWidyaiswara extends Controller {
    ...
    public function __construct() {
        ...
        $this->indexUrl = IURLConstant::AGENDA_WIDYAISWARA_INDEX_URL;
        $this->viewPath = IViewConstant::AGENDA_WIDYAISWARA_VIEW_INDEX;
