 ...
 * Time: 24:00
 */
class OrganizerSurvey extends ControllerMember {
    ...
    public function __construct() {
        ...
        $this->indexUrl = IURLMemberConstant::SURVEY_ORGANIZER_URL;
        $this->viewPath = IViewMemberConstant::SURVEY_ORGANIZER_VIEW_INDEX;
        $this->setAutoCrud();
        parent::__construct();
    }
