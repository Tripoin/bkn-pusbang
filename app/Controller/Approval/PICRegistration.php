...
//        echo $Datatable->search;
        ...
        $whereList = $masterApprovalCategory->getEntity() . DOT . $masterApprovalCategory->getId() . EQUAL . $masterApproval->getEntity() . DOT . $masterApproval->getApprovalCategoryId() . ""
                . " AND ".$masterApproval->getEntity().DOT.$masterApproval->getApprovalDetailId().EQUAL.$transactionRegistration->getEntity().DOT.$transactionRegistration->getId().""
                . " AND " . $masterApprovalCategory->getEntity() . DOT . $masterApproval->getCode() . equalToIgnoreCase('REGISTRATION') .""
                . ""  . $search;

        $list_data = $Datatable->select_pagination($masterApproval, $masterApproval->getEntity(), $whereList, array($masterApprovalCategory->getEntity(),$transactionRegistration->getEntity()), $masterApprovalCategory->getEntity(), $this->orderBy, ""
